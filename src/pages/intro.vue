<template>
  <div class="flex justify-center pt-20 pb-20 overflow-hidden">
    <div class="z-10 flex flex-col w-full self-center <md:px-5">
      <div v-for="(item, key) in dummyData" :key="key" class="flex justify-start pb-15 pt-3 relative px-20 <md:px-0 h-screen items-center" :class="!(key & 1) ? 'justify-start': 'justify-end'">
      ...
      <Button class="w-full max-w-[300px] max-h-max py-4 self-center bg-[#FCFBF5] hover:bg-cream transition-colors" @click="$router.push('/story')">
