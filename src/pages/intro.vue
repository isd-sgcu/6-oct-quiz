...
const info = [
  ...
  {
    details: ['ในเดือนตุลาฯ หนึ่งของปี ๒๕๑๖ และ ๒๕๑๙', 'มีเพื่อนเราหลายคนผ่านเหตุการณ์ที่สําคัญหนึ่งของชีวิตมา'],
    bgColor: '#FCFBF5',
    textColor: '#000000',
  },
  {
  ...
  {
    details: ['เดือนตุลาฯ พรากหลายอย่างจากพวกเขาและเธอไปมากมาย', 'แต่กระนั้นความสูญเสียนี้ก็ให้บทเรียนล้ำค่าและสร้างตัวตนของคนเดือนตุลาฯ มาไม่น้อย', 'เขาและเธอเหล่านี้เลือกเส้นทางประชาธิปไตยอย่างแน่วแน่มาตลอด แต่บางคนก็เปลี่ยนแปลงไป มากบ้างน้อยบ้าง'],
    bgColor: 'rgba(55, 41, 32, 0.9)',
    textColor: '#FFFFFF',
  },
  {
    details: ['คนเดือนตุลาฯ สร้างอะไรไว้ให้สังคมมากมาย จิตวิญญาณของพวกเขาและความเป็นคนเดือนตุลาฯ เติบโตในทุก ๆ ที่', 'คุณอยากรู้รึเปล่า ว่าจิตวิญญาณของพวกเขาเติบโตในตัวคุณบ้างไหม คุณคือใครในเดือนตุลาฯ'],
    bgColor: '#FCFBF5',
    textColor: '#000000',
  },
]
